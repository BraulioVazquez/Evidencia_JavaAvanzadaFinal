...
public class UserRest {
	...
	public Map<String, Object> getUsersJSON() {
		...
		link1.put("href","http://localhost:8088/utm/api/v1/user");
		link1.put("rel","user");
		
		Map<String, Object> link2 = new HashMap<>();
		link2.put("href","http://localhost:8088/utm/api/v1/anakin");
		link2.put("rel","self");

		links.put("user",link1);
		links.put("self",link2);

		Map<String, Object> userData = new HashMap<>();
		userData.put("fullname","anakin");
		userData.put("password","skywalker");
		userData.put("username","anakin");
	...
	public UserLinkListResource getUsersXML() {
		...
		Map<String, Object> userLinksResource = new HashMap<>();

		Map<String, Object> link1 = new HashMap<>();

		link1.put("http://localhost:8088/utm/api/v1/","api");
		//link1.put("rel","api");
		link1.put("http://localhost:8088/utm/api/v1/user","self");
		link1.put("http://localhost:8088/utm/api/v1/anakin", "anakin");
		link1.put("http://localhost:8088/utm/api/v1/obivan", "obivan");
		link1.put("http://localhost:8088/utm/api/v1/mace", "mace");
		link1.put("http://localhost:8088/utm/api/v1/shaak", "shaak");
